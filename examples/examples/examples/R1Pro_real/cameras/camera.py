...
image_left,image_right,image_top,thread_run=np.zeros((480, 640, 3), np.uint8),np.zeros((480, 640, 3), np.uint8),np.zeros((480, 640, 3), np.uint8),1
...
class ImageRecorder:
    ...
    def get_images(self):
        return {"cam_high": image_top.copy().astype(np.uint8),
