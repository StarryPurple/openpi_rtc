...
from examples.xtrainer_real.scripts.function_util import mismatch_data_write, wait_period, log_write, mk_dir, scan_port
import numpy as np
...
class DynamixelDriver(DynamixelDriverProtocol):
    def __init__(
        self, ids: Sequence[int], append_id: int, port: str = "/dev/ttyUSB0", baudrate: int = 2000000, using_sensor = True
    ):
...
def main():
    ...
    driver1 = DynamixelDriver(ids_right, 13, "/dev/ttyACM0")
